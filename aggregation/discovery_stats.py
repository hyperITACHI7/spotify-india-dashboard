...
def get_topics_matrix(date_range: str, version: str, rating: str, platform: str, search: str, mode: str = None) -> List[Dict[str, Any]]:
    ...
    for topic_id, topic_reviews in topic_buckets.items():
        ...
        # Snapshot mode: return pre-computed summaries directly — no DB lookup, no LLM
        if effective_mode == "snapshot" and topic_id in _MOCK_TOPIC_SUMMARIES:
            summary = _MOCK_TOPIC_SUMMARIES[topic_id]
        else:
            # Live mode: read from topic_summaries DB (populated by Phase 3 of the NLP
            # pipeline on every scrape). Falls back to rule-based if DB has no entry yet
            # (e.g. NLP still running) or the stored text is a low-quality template.
            db_summary = _get_phase3_summary(topic_id)
            if db_summary and not _is_low_quality_summary(db_summary):
                summary = db_summary
            else:
                summary = _build_core_issue_summary(topic_reviews, topic_id)
...
_MOCK_SUBTOPIC_DATA: Dict[str, List[Dict]] = {
    "search_discovery": [
        {"sub_topic": "Recommendation relevance", "reviews_count": 11, "avg_sentiment":  0.05, "pct_negative": 45},
        {"sub_topic": "Algorithm learning",        "reviews_count":  2, "avg_sentiment":  0.08, "pct_negative": 50},
        {"sub_topic": "Repetitive suggestions",    "reviews_count":  1, "avg_sentiment": -0.85, "pct_negative": 100},
        {"sub_topic": "Release Radar",             "reviews_count":  1, "avg_sentiment": -0.85, "pct_negative": 100},
        {"sub_topic": "Regional music discovery",  "reviews_count":  1, "avg_sentiment": -0.60, "pct_negative": 100},
        {"sub_topic": "Autoplay relevance",        "reviews_count":  1, "avg_sentiment": -0.75, "pct_negative": 100},
        {"sub_topic": "Search accuracy",           "reviews_count":  1, "avg_sentiment": -0.40, "pct_negative": 100},
        {"sub_topic": "Daily Mix quality",         "reviews_count":  1, "avg_sentiment":  0.90, "pct_negative": 0},
    ],
    "performance_crashes": [
        {"sub_topic": "App crashes",    "reviews_count": 11, "avg_sentiment":  0.02, "pct_negative": 45},
        {"sub_topic": "Startup freezes","reviews_count":  1, "avg_sentiment": -0.95, "pct_negative": 100},
        {"sub_topic": "Scrolling lag",  "reviews_count":  1, "avg_sentiment": -0.60, "pct_negative": 100},
        {"sub_topic": "Battery drain",  "reviews_count":  1, "avg_sentiment": -0.60, "pct_negative": 100},
    ],
    "ads_experience": [
        {"sub_topic": "Ad frequency","reviews_count": 11, "avg_sentiment":  0.03, "pct_negative": 45},
        {"sub_topic": "Audio ads",   "reviews_count":  1, "avg_sentiment": -0.85, "pct_negative": 100},
        {"sub_topic": "Ad volume",   "reviews_count":  1, "avg_sentiment": -0.75, "pct_negative": 100},
    ],
    "offline_mode": [
        {"sub_topic": "Offline playback",    "reviews_count": 11, "avg_sentiment":  0.03, "pct_negative": 45},
        {"sub_topic": "Download reliability","reviews_count":  2, "avg_sentiment": -0.03, "pct_negative": 50},
        {"sub_topic": "Storage management",  "reviews_count":  1, "avg_sentiment": -0.65, "pct_negative": 100},
        {"sub_topic": "Sync issues",         "reviews_count":  1, "avg_sentiment": -0.65, "pct_negative": 100},
    ],
    "playlists_library": [
        {"sub_topic": "Library organization",   "reviews_count": 11, "avg_sentiment":  0.06, "pct_negative": 45},
        {"sub_topic": "Playlist creation",      "reviews_count": 11, "avg_sentiment":  0.05, "pct_negative": 45},
        {"sub_topic": "Liked songs",            "reviews_count":  1, "avg_sentiment": -0.50, "pct_negative": 100},
        {"sub_topic": "Queue management",       "reviews_count":  1, "avg_sentiment": -0.70, "pct_negative": 100},
        {"sub_topic": "Collaborative playlists","reviews_count":  1, "avg_sentiment":  0.75, "pct_negative": 0},
    ],
    "ui_layout": [
        {"sub_topic": "Navigation",          "reviews_count": 12, "avg_sentiment":  0.19, "pct_negative": 33},
        {"sub_topic": "Dark mode",           "reviews_count":  1, "avg_sentiment": -0.55, "pct_negative": 100},
        {"sub_topic": "Font and readability","reviews_count":  1, "avg_sentiment": -0.55, "pct_negative": 100},
        {"sub_topic": "Home screen",         "reviews_count":  1, "avg_sentiment":  0.10, "pct_negative": 0},
    ],
    "subscriptions_pricing": [
        {"sub_topic": "Premium value",   "reviews_count": 11, "avg_sentiment":  0.05, "pct_negative": 45},
        {"sub_topic": "Family plan",     "reviews_count":  1, "avg_sentiment": -0.70, "pct_negative": 100},
        {"sub_topic": "Student discount","reviews_count":  1, "avg_sentiment":  0.90, "pct_negative": 0},
    ],
    "content_availability": [
        {"sub_topic": "Missing songs",        "reviews_count": 11, "avg_sentiment":  0.04, "pct_negative": 45},
        {"sub_topic": "Catalog gaps",         "reviews_count":  1, "avg_sentiment": -0.80, "pct_negative": 100},
        {"sub_topic": "Regional restrictions","reviews_count":  1, "avg_sentiment": -0.10, "pct_negative": 0},
    ],
    "social_sharing": [
        {"sub_topic": "Instagram sharing","reviews_count": 11, "avg_sentiment":  0.07, "pct_negative": 45},
        {"sub_topic": "Group sessions",   "reviews_count":  1, "avg_sentiment":  0.70, "pct_negative": 0},
    ],
    "podcasts": [
        {"sub_topic": "Podcast clutter",        "reviews_count": 11, "avg_sentiment":  0.06, "pct_negative": 45},
        {"sub_topic": "Podcast recommendations","reviews_count":  1, "avg_sentiment": -0.50, "pct_negative": 100},
        {"sub_topic": "Playback controls",      "reviews_count":  1, "avg_sentiment":  0.85, "pct_negative": 0},
    ],
    "account_login": [
        {"sub_topic": "Login failures", "reviews_count": 11, "avg_sentiment":  0.06, "pct_negative": 45},
        {"sub_topic": "Two-factor auth","reviews_count":  1, "avg_sentiment": -0.50, "pct_negative": 100},
    ],
    "audio_quality": [
        {"sub_topic": "Lossless/HiFi",    "reviews_count": 11, "avg_sentiment":  0.07, "pct_negative": 45},
        {"sub_topic": "Streaming quality","reviews_count":  1, "avg_sentiment": -0.40, "pct_negative": 100},
        {"sub_topic": "Equalizer",        "reviews_count":  1, "avg_sentiment":  0.90, "pct_negative": 0},
    ],
}
